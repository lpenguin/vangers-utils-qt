            ...
            renderPasses: [
                RenderPass {
                    shaderProgram: ShaderProgram {
                        vertexShaderCode:   loadSource("qrc:/modelviewer/shaders/robustwireframe.vert")
                        geometryShaderCode: loadSource("qrc:/modelviewer/shaders/robustwireframe.geom")
                        fragmentShaderCode: loadSource("qrc:/modelviewer/shaders/robustwireframe.frag")
                    }
                }
            ]
        }
