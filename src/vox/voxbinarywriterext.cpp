...
template<>
void vangers::BinaryWriter::write<>(const QString& str){
...
template<>
void vangers::BinaryWriter::write<>(const Dict& dict){
...
template<>
void vangers::BinaryWriter::write<>(const ShapeNodeModel& nodeModel){
	write<int32_t>(nodeModel.modelId);
	write(nodeModel.modelAttributes);
}

template<>
void vangers::riff::encodeChunkContents<>(const TransformNode& node, BinaryWriter& writer, Chunk& chunk){
	chunk.setId("nTRN");
...
template<>
void vangers::riff::encodeChunkContents<>(const ShapeNode& node, BinaryWriter& writer, Chunk& chunk){
	chunk.setId("nSHP");
	writer.write(node.nodeId);
	writer.write(node.attributes);
...
template<>
void vangers::riff::encodeChunkContents<>(const Layer& layer, BinaryWriter& writer, Chunk& chunk){
	chunk.setId("LAYR");
...
template<>
void vangers::riff::encodeChunkContents<>(const GroupNode& node, BinaryWriter& writer, Chunk& chunk){
	chunk.setId("nGRP");
	writer.write(node.nodeId);
	writer.write(node.attributes);
...
template<>
void vangers::riff::encodeChunkContents<Pack>(const Pack& pack, BinaryWriter& writer, Chunk& chunk){
	chunk.setId("PACK");
	writer.write(pack.numModels);
}

template<>
void vangers::riff::encodeChunkContents(const Model& model, BinaryWriter& writer, Chunk& chunk){
	chunk.setId("SIZE");
...
template<>
void vangers::riff::encodeChunkContents(const ModelVoxels& modelVoxels, BinaryWriter& writer, Chunk& chunk){
	chunk.setId("XYZI");
...
template<>
void vangers::riff::encodeChunkContents(const Material& material, BinaryWriter& writer, Chunk& chunk){
	chunk.setId("MATL");
...
template<>
void vangers::riff::encodeChunkContents(const RenderObjects& ro, BinaryWriter& writer, Chunk& chunk){
	chunk.setId("rOBJ");
	writer.write(ro.attributes);
}

template<>
void vangers::riff::encodeChunkContents(const RenderCamera& rc, BinaryWriter& writer, Chunk& chunk){
	chunk.setId("rCAM");
	writer.write(rc.id);
...
template<>
void vangers::riff::encodeChunkContents(const PaletteNote& note, BinaryWriter& writer, Chunk& chunk){
	chunk.setId("NOTE");
...
template<>
void vangers::riff::encodeChunkContents(const Vox& vox, BinaryWriter& , Chunk& chunk){
	chunk.setId("MAIN");
...
template<>
void vangers::riff::encodeChunkContents(const Palette& palette, BinaryWriter& writer, Chunk& chunk){
	chunk.setId("RGBA");
...
template<>
void vangers::BinaryWriter::write<Vox>(const Vox& vox)
{
	Riff riff;
	riff.setId("VOX ");
	riff.version = 150;
