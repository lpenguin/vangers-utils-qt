...
QSharedPointer<QImage> imageFromData(const uint8_t* data, int sizeX, int sizeY, const Palette& palette){
...
void Vmap::setPalette(const Palette &palette)
{
	_palette = palette;
}
...
Palette& Vmap::palette()
{
	return _palette;
}

const Palette &Vmap::paletteConst() const
{
	return _palette;
}
