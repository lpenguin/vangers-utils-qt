...
template<>
void setupProperty(QTreeWidgetItem* item, const m3d::Vertex& property);

template<>
void setupProperty(QTreeWidgetItem* item, const m3d::Normal& property);

template<>
void setupProperty(QTreeWidgetItem* item, const m3d::PolygonNormal& property);
...
template<>
void setupProperty(QTreeWidgetItem* item, const m3d::PolygonIndex& property);

template<>
void setupProperty(QTreeWidgetItem* item, const m3d::Polygon& property);


template<>
void setupProperty(QTreeWidgetItem* item, const m3d::C3D& c3d);

template<>
void setupProperty(QTreeWidgetItem* item, const m3d::M3D& property);

template<>
void setupProperty(QTreeWidgetItem* item, const m3d::A3D& property);
